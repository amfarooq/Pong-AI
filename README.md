...
The paddle is an AI agent that is trying to learn how to play the game successfully. The game keeps starting over if it is lost and the game count is updated. 
